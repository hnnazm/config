...
require("lazy").setup({
  ...
  },
  {
    ...
    keys = {
      ...
      { "<Leader><Leader>gb",       "<Cmd> FzfLua git_blame<CR>",      desc = "Fuzzy find blame" },
      { "<Leader><Leader>gh",       "<Cmd> FzfLua git_hunks<CR>",      desc = "Fuzzy find hunks" },
      { "<Leader><Leader>gd",       "<Cmd> FzfLua git_diff<CR>",       desc = "Fuzzy find diff" },
      { "<Leader><Leader>gs",       "<Cmd> FzfLua git_stash<CR>",      desc = "Fuzzy find stash" },
